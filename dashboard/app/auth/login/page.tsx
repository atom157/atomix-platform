...
function LoginForm() {
  ...
  // Auto-trigger Google OAuth when arriving from the extension
  const hasAutoTriggered = React.useRef(false)
  React.useEffect(() => {
    if (source === 'extension' && !hasAutoTriggered.current && !message) {
        ...
        <div className="flex flex-col gap-6">
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Sign in to your X Reply Generator account
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex flex-col gap-4">
                {message === 'google-not-configured' && (
